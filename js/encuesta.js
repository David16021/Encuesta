$(document).ready(function() {
    ...
    $('input[type="radio"][name="pregunta1_cinco"]').change(function() {
        switch(this.value) {
            case 'Si':
    ...
    $('input[type="radio"][name="pregunta1_unique"]').change(function() {
        switch(this.value) {
            case 'Si':
            ...
            case 'No':
                ...
                if(!document.getElementsByClassName("question8unique").length) {
                    ...
                    var question6uniqueValue = $('input[name="pregunta6_unique"]:checked').val();
    ...
    $('input[type="radio"][name="pregunta6"]').change(function() {
        $("#rowQuestion3").css('display', 'block');
    });
});